...
const Footer = () => {
  return (
    <footer className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
            ...
            <div className="flex flex-col my-4 min-w-[150px] ss:my-0">
              ...
              <ul className="list-none mt-4">
                { footerLink.links.map((link, index) => (
                  <li key={link.name} className={`font-poppins font-normal text-base leading-[24px] text-dimWhite cursor-pointer hover:text-secondary ${ index !== footerLink.links.length - 1 ? 'mb-4' : 'mb-0'}`}>
                    { link.name }
                  </li>
                ))}
              </ul>
      ...
      <div className="w-full flex justify-between items-center flex-col md:flex-row pt-6 border-t-[1px] border-t-[#3f3e56]">
        <p className="font-poppins font-normal text-center  text-lg leading-[27px] text-white">2022. HooBank. All Rights Reserved</p>
